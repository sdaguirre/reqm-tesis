        ...
        try {
            ...
            if (request.getParameter("ok.x") != null) {
                ...
                DAODispositivos daoequipo = new DAODispositivos(new Long(request.getParameter("inCode")),new Long(request.getParameter("inFKey")),
                        new Integer(request.getParameter("inType")), new Integer(request.getParameter("inNet")),request.getParameter("inRef"), request.getParameter("inPerson"), request.getParameter("inUser"), request.getParameter("inPass"),request.getParameter("inIP"),request.getParameter("inNetNm"));
