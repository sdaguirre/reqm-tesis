...
{
	$("#hide").hide();
	$("#gesercon").mouseover(function(){
		if(is == 1){
			var stext=$("#softwaretext");
			var img=$("#software");
			stext.hide();
			img.hide();
			img.attr("src","../imgs/1-p2.jpg");
			stext.text("Conozca Gersecon");
			stext.fadeIn("slow");
			img.fadeIn("slow");
			is = 0;
		}
	});
	$("#jiva").mouseover(function(){
		if(is == 0){
			var stext=$("#softwaretext");
			var img=$("#software");
			stext.hide();
			img.hide();
			img.attr("src","../imgs/1-p1.jpg");
			stext.text("Conozca Jiva");
			stext.fadeIn("slow");
			img.fadeIn("slow");
			is = 1;
		}
