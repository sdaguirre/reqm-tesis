                                            ...
                                            <div id="cont-col">
                                                <div class="ind">
                                                    ...
                                                    <div class="node">
                                                        ...
                                                        <div class="content">
                                                            <div class="services">Por favor, seleccione el cliente deseado para la visualizaci&#243;n de sus Anteproyectos.
                                                                <br />
                                                                                            ...
                                                                                            <xsl:for-each select="/root/permisos/sitio[@id=201]">
                                                                                                <xsl:if test="./sel='true'">
                                                                                                    <li>
                                                                                                        <span>
                                                                                                            <a id="formLink" >
                                                                                                                <xsl:attribute name="href">Anteproyectos?ins=<xsl:value-of select="$key" />&#38;iframe=true&#38;width=60%&#38;height=100%</xsl:attribute>
                                                                                                            ...
                                                                                                            <span class="formButtons">Nuevo Anteproyecto</span>
                                                                                                        </span>
                                                                                                    </li>
                                                                                                </xsl:if>
                                                                                                <xsl:if test="./ins='true'">
                                                                                                    <li>
                                                                                                        ...
                                                                                                        <span class="formButtons">
                                                                                                            <a id="formLink" >
                                                                                                                <xsl:attribute name="href">Anteproyectos?fkey=<xsl:value-of select="$key" /></xsl:attribute>
