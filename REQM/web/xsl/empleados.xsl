                        ...
                        <div id="main">
                            <div id="header">
                                ...
                                <div class="head-row2">
                                    ...
                                    <div class="col2">
                                        <form method="POST" action="Empleados" accept-charset="UTF-8" id="search-theme-form">
                                            <div>
                                            ...
                                            <div id="cont-col">
                                                <div class="ind">
                                                    ...
                                                    <div class="node">
                                                        ...
                                                        <div class="content">
                                                            <div class="services">Esta interfaz permite la administracion de empleados del sistema
                                                                <br />
                                                                        ...
                                                                        <form method="post" action="Empleados">
                                                                            ...
                                                                            <table id="report" width="500px">
                                                                                <tr>
                                                                                    ...
                                                                                    <th>Nombre</th>
                                                                                    <th id="former">
                                                                                    <xsl:for-each select="/root/permisos/sitio[@id=102]">
                                                                                        <xsl:if test="./ins='true'">
                                                                                            <a id="formNew" rel="prettyPhoto[new]" href="Empleados?ins=true&#38;iframe=true&#38;width=60%&#38;height=100%" >
                                                                                                ...
                                                                                                <xsl:for-each select="/root/permisos/sitio[@id=104]">
                                                                                                    <xsl:if test="./sel='true'">
                                                                                                        <li>
                                                                                                            ...
                                                                                                            <span class="formButtons">
                                                                                                                <a id="formLink" >
                                                                                                                    <xsl:attribute name="href">PDocumentos?fkey=<xsl:value-of select="$fkey" /></xsl:attribute>
                                                                                                        ...
                                                                                                        <xsl:if test="./mod='true'">
                                                                                                            <span class="formButtons">
                                                                                                                <a id="formLink" rel="prettyPhoto[mod]" >
                                                                                                                    <xsl:attribute name="href">Empleados?mod=<xsl:value-of select="$key" />&#38;iframe=true&#38;width=650&#38;height=100%</xsl:attribute>
