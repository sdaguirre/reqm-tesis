                                            ...
                                            <div id="cont-col">
                                                <div class="ind">
                                                    ...
                                                    <div class="node">
                                                        ...
                                                        <div class="content">
                                                            <div class="services">Este reporte permite la visualizacion de los requerimientos finales de un proyecto, seleccione un cliente
                                                                <br />
                                                                        ...
                                                                        <div class="modifier-product-right-detail" id="product_list">
                                                                            <div class="product-list">
                                                                                <dt id="dot">
                                                                                    ...
                                                                                    <dd id="dot">
                                                                                        <div class="product"><a><xsl:attribute name="href">Informes?akey=<xsl:value-of select="@key"/></xsl:attribute><xsl:value-of select="name"/></a></div>
                                                                                    </dd>
                                                                                    </xsl:for-each>
                                                                                </dt>
                                                                            </div>
