                                ...
                                <div class="cont-inner">
                                    <div class="bg-line-left">
                                        <div>
                                                            ...
                                                            <div class="block-top">
                                                                ...
                                                                <div class="content">
                                                                    <ul class="menu">
                                                                        ...
                                                                        <li class="leaf last"><div id="selected">Documentos</div></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div id="cont-col">
                                                <div class="ind">
                                                    <h2>Administrador de Documentos de Personas</h2>
                                                    <!-- start main content -->
                                                    <div class="node">
                                                        <div class="taxonomy"></div>
                                                        <div class="content">
                                                            <div class="services">Esta interfaz permite la administracion de documentos del registro de una persona del sistema
                                                                <br />
                                                                ...
                                                                <div class="columns">
                                                                    <div class="column-left">
                                                                        <form method="post" action="PDocumentos">
