                                                            ...
                                                            <div class="block-top">
                                                                ...
                                                                <div class="content">
                                                                    <ul class="menu">
                                                                        ...
                                                                        <li class="leaf"><div id="selected">Proyectos</div></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div id="cont-col">
                                                <div class="ind">
                                                    ...
                                                    <div class="node">
                                                        ...
                                                        <div class="content">
                                                            <div class="services">Esta interfaz permite la administracion de proyectos de un cliente del sistema
                                                                <br />
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <xsl:for-each select="/root/permisos/sitio[@id=202]">
                                                                                        <xsl:if test="./ins='true'">
                                                                                            <a id="formNew" rel="prettyPhoto[new]" href="Proyectos?ins=true&#38;iframe=true&#38;width=60%&#38;height=100%" >
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="5">
                                                                                            ...
                                                                                            <div class="xsldetalle">
                                                                                                <div class="xsldbox">Estado:
                                                                                                    <xsl:value-of select="estado" />
                                                                                                </div>
                                                                                                <div>Costo:
                                                                                                    <xsl:value-of select="value" />
                                                                                                </div>
                                                                                                <div class="xsldbox">Fecha Inicio:
                                                                                            ...
                                                                                            <ul class="gallery clearfix">
                                                                                                <xsl:for-each select="/root/permisos/sitio[@id=205]">
                                                                                                ...
                                                                                                <xsl:for-each select="/root/permisos/sitio[@id=202]">
                                                                                                    <xsl:if test="./sel='true'">
                                                                                                        <li>
                                                                                                            <span class="formButtons">
                                                                                                                <a id="formLink" >
                                                                                                                    <xsl:attribute name="href">Requerimientos?prkey=<xsl:value-of select="$key" /></xsl:attribute>
                                                                                                                    <img src="imgs/buttons/open.png" alt="Ver Requerimientos Definidos" />
                                                                                                        ...
                                                                                                        <xsl:if test="./mod='true'">
                                                                                                            <span class="formButtons">
                                                                                                                <a id="formLink" rel="prettyPhoto[mod]" >
                                                                                                                    <xsl:attribute name="href">Proyectos?mod=<xsl:value-of select="$key" />&#38;iframe=true&#38;width=60%&#38;height=100%</xsl:attribute>
