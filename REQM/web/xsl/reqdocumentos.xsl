                        ...
                        <div id="main">
                            <div id="header">
                                ...
                                <div class="head-row2">
                                    ...
                                    <div class="col2">
                                        <form method="POST" action="ReqDocumentos" accept-charset="UTF-8" id="search-theme-form">
                                            <div>
                                ...
                                <div class="cont-inner">
                                    <div class="bg-line-left">
                                        <div>
                                                        ...
                                                        <div class="block block-user" id="block-user-1">
                                                            <div class="block-top">
                                                                ...
                                                                <div class="content">
                                                                    <ul class="menu">
                                                                        <li class="leaf first">
                                                                            <a href="Proyectos?step=1">Clientes</a>
                                                                        </li>
                                                                        <li class="leaf"><a href="Proyectos?step=2">Proyectos</a></li>
                                                                        <li class="leaf"><a href="Requerimientos">Requerimientos</a></li>
                                            ...
                                            <div id="cont-col">
                                                <div class="ind">
                                                    <h2>Administrador de Documentos de Requerimientos</h2>
                                                    <!-- start main content -->
                                                    <div class="node">
                                                        <div class="taxonomy"></div>
                                                        <div class="content">
                                                            <div class="services">Esta interfaz permite la administracion de documentos generados de un requerimiento
                                                                <br />
                                                                ...
                                                                <div class="columns">
                                                                    <div class="column-left">
                                                                        <form method="post" action="ReqDocumentos">
                                                                            ...
                                                                            <table id="report" width="500px">
                                                                                <tr>
                                                                                    ...
                                                                                    <xsl:for-each select="/root/permisos/sitio[@id=104]">
                                                                                        ...
                                                                                        <a id="formNew" rel="prettyPhoto[new]" href="ReqDocumentos?ins=true&#38;iframe=true&#38;width=60%&#38;height=100%" >
                                                                                            ...
                                                                                            <ul class="gallery clearfix">
                                                                                                <li>
                                                                                                    <span class="formButtons">
                                                                                                        <a id="formLink">
                                                                                                            <xsl:attribute name="href">ReqDocumentos?down=<xsl:value-of select="$key" /></xsl:attribute>
                                                                                                        ...
                                                                                                        <xsl:if test="./mod='true'">
                                                                                                            <span class="formButtons">
                                                                                                                <a id="formLink" rel="prettyPhoto[mod]" >
                                                                                                                    <xsl:attribute name="href">ReqDocumentos?mod=<xsl:value-of select="$key" />&#38;iframe=true&#38;width=60%&#38;height=100%</xsl:attribute>
                                                                                                        ...
                                                                                                        <xsl:if test="./mod='true'">
                                                                                                            ...
                                                                                                            <span class="formButtons">
                                                                                                                <a id="formLink">
                                                                                                                    ...
                                                                                                                    <xsl:attribute name="href">ReqDocumentos?upl=<xsl:value-of select="$key" />&#38;iframe=true&#38;width=60%&#38;height=100%</xsl:attribute>
